...
%   model_def_file = '/usr/local/opt/caffe/examples/imagenet/imagenet_deploy.prototxt';
   model_def_file = '/mnt/imatge-work/alidon/PFM/src/Distance/CN7/deploy_features.prototxt';
  model_file = '/usr/local/opt/caffe/examples/imagenet/caffe_reference_imagenet_model';
...
% average output scores
%save('/mnt/imatge-work/alidon/PFM/src/Distance/CN7/scores.mat' ,'scores');
