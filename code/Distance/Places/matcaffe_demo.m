...
%   model_def_file = '/usr/local/opt/caffe/examples/imagenet/imagenet_deploy.prototxt';
   model_def_file = '/mnt/imatge-work/alidon/PFM/src/Distance/Places/hybridCNN_deploy_upgraded.prototxt';
  model_file = '/mnt/imatge-work/alidon/PFM/src/Distance/Places/hybridCNN_iter_700000_upgraded.caffemodel';
...
scores = reshape(scores{1}, [1183 10]);
scores = mean(scores, 2);
