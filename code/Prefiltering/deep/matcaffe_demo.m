...
%   model_def_file = '/usr/local/opt/caffe/examples/imagenet/imagenet_deploy.prototxt';
   model_def_file = '/imatge/alidon/work/PFM/src/Prefiltering/deep/train_val_finetunning_test.prototxt';
  model_file = '/imatge/alidon/work/PFM/src/Prefiltering/deep/informativeDetectCNN_finetunning_Petia2_iter_2800.caffemodel';
